# -*- coding: utf-8 -*-
"""独立审查脚本（temp，不入库）：按带内 8n 行结构从 oracle 缓存 HTML 提取星名/四化/宫支，
与 l3_ziwei.compute 输出交叉验证。实现独立手写（不 import _zw_oracle_probe）。"""
import os, re, sys
...
CASES = [
    ...
    ("1977-01-13-08-00-r0.html", (1977, 1, 13, 8, 0), "丁巳巳酉丑组"),
